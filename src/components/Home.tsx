                ...
                <ul className="flex items-center flex-wrap gap-2">
                  {svgfrontend.map((link) => (
                    <li key={link.id} className="group relative duration-30">
                      <span className="absolute hidden group-hover:flex -left-0 -bottom-14 -translate-y-full px-2 py-1 bg-white rounded-lg text-center text-gray-700 dark:text-blue-200 text-sm font-bold">
                        {link.name}
                      </span>
